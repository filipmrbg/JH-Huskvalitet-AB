...
export const services: ServiceItem[] = [
  {
    ...
    heroText: 'Förverkliga dina drömmar för utemiljön med professionell stensättning, stödmurar och komplett tomtplanering i Jönköping med omnejd.',
  ...
  },
  {
    ...
    heroText: 'Kommande somrars favoritplats. Vi bygger måttanpassade trädäck, uterum, utekök, staket och altaner för ditt hem i Jönköping med omnejd.',
    ...
    heroImage: '/bygg-new.webp',
    image: '/bygg-new.webp',
    href: '/tjanster#bygg',
  },
  {
    slug: 'dranering-va',
    title: 'Dränering och VA',
    ...
    heroImage: '/dranering-new.webp',
    image: '/dranering-new.webp',
  ...
  },
  {
    ...
    heroText: 'Säker trädfällning, tomtgallring och stubbfräsning i Jönköping med omnejd med över 40 års samlad skogserfarenhet.',
