    ...
    sections: [
      {
        ...
        bullets: [
          'Projektering & bygglov – Stöd och rådgivning inför byggstart',
          'Grundläggning & stomme – Gediget hantverk med lång hållbarhet',
          'Interiör & finish – Omsorgsfullt snickeri och moderna installationer',
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'Golv & Ytskikt – Parkett, målning, lister och finsnickeri',
          'Fasad & Tak – Skyddande renovering som tål det nordiska klimatet',
        ],
      },
    ],
    faq: [
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'Uterum & Glaspartier – Förläng säsongen med isolerade partier',
          'Avväxling av bärande vägg – Skapa öppna, ljusa och moderna ytor',
          'Vindsombyggnad & Taklyft – Utnyttja husets dolda potential',
        ],
      },
    ],
    faq: [
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'Dokumentation & Egenkontroller – Komplett underlag vid slutbesiktning',
          'Garanti & Försäkring – Fullt skydd för din investering',
        ],
      },
    ],
    faq: [
